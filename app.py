...
model = pickle.load(open(r"C:\Users\91807\OneDrive\Desktop\Divyanshu Chauhan\3rd year\Web Technology\loan_prediction-main\loan_prediction-main\model.pkl", "rb"))
...
def predict():
    if request.method ==  'POST':
        ...
        if(prediction=="N"):
            prediction="Sorry! You are not applicable for Loan"
        else:
            prediction="Congratulations! You are applicable for Loan"
